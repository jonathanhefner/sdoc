...
describe SDoc::Postprocessor do
  ...
  describe "#process" do
    it "guesses languages and highlights code snippets" do
      ...
      _(SDoc::Postprocessor.process(rendered)).must_match expected
    end
  end

  describe "#highlight_code" do
    it "returns highlighted HTML" do
      _(SDoc::Postprocessor.highlight_code("1 + 1", "ruby")).must_equal \
        %{<span class="mi">1</span> <span class="o">+</span> <span class="mi">1</span>}

      _(SDoc::Postprocessor.highlight_code("$ rails s", "console")).must_equal \
  ...
  describe "#guess_code_language" do
    ...
    it "guesses console for CLI sessions" do
      _(SDoc::Postprocessor.guess_code_language(<<~SESSION)).must_equal "console"
        $ rails server
        Booting
      SESSION
    end
